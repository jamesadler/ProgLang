...
public class Migrate extends UniversalActor  {
	...
	public Migrate(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "demo.Migrate", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "demo.Migrate$State" );
		...
		public void print() {
			{
				...
				{
					Object _arguments[] = { "Migrate actor just migrated here." };
		...
		public void act(String[] args) {
			if (args.length!=3) {{
				{
					...
					{
						Object _arguments[] = { "Usage: java migration.Migrate  <UAN> <srcUAL> <destUAL> " };
						Message message = new Message( self, standardOutput, "println", _arguments, null, null );
						__messages.add( message );
					}
				}
			...
			Migrate migrateActor = ((Migrate)new Migrate(uan, ual,this).construct());
			{
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, migrateActor, "print", _arguments, null, token_2_0 );
					__messages.add( message );
				}
				// migrateActor<-migrate(args[2])
				{
					Object _arguments[] = { args[2] };
					Message message = new Message( self, migrateActor, "migrate", _arguments, token_2_0, token_2_1 );
					__messages.add( message );
				}
				// migrateActor<-print()
				{
					Object _arguments[] = {  };
					Message message = new Message( self, migrateActor, "print", _arguments, token_2_1, null );
					__messages.add( message );
				}
			}
		}
