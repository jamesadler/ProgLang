...
public class Main extends UniversalActor  {
	...
	public Main(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "spoon_files.Main", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "spoon_files.Main$State" );
		...
		public void act(String[] args) {
			Spun acr1;
			Spun acr2;
			acr1 = ((Spun)new Spun(new UAN("uan://127.0.0.1:3030/acr1"), new UAL("rmsp://172.17.37.10:4040/acr1"),this).construct());
			acr2 = ((Spun)new Spun(new UAN("uan://127.0.0.1:3030/acr2"), new UAL("rmsp://172.17.37.10:4041/acr2"),this).construct());
			{
				// acr1<-print("Caroline")
				{
					Object _arguments[] = { "Caroline" };
					Message message = new Message( self, acr1, "print", _arguments, null, null );
			...
			}
			{
				// acr2<-print("Spoon")
				{
					Object _arguments[] = { "Spoon" };
					Message message = new Message( self, acr2, "print", _arguments, null, null );
					__messages.add( message );
				}
			}
		}
