...
public class Spun extends UniversalActor  {
	public static void main(String args[]) {
		...
		Spun instance = (Spun)new Spun(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Spun(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Spun.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Spun(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Spun.getReferenceByLocation(new UAL(ual)); }
	public Spun(boolean o, UAN __uan)	{ super(false,__uan); }
	public Spun(boolean o, UAL __ual)	{ super(false,__ual); }
	public Spun(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Spun(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Spun(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Spun()		{  }
	public Spun(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "spoon_files.Spun", sourceRef);
			  }
	...
	public UniversalActor construct (Object initContents) {
		Object[] __arguments = { initContents };
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Spun)actorReference).setUAL(getUAL());
			((Spun)actorReference).setUAN(getUAN());
			self = new Spun(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "spoon_files.Spun$State" );
		...
		Object contents;
		void construct(Object initContents){
		...
		public void print(String arg) {
			{
				...
				// append(arg)
				{
					Object _arguments[] = { arg };
					Message message = new Message( self, self, "append", _arguments, null, token_2_0 );
